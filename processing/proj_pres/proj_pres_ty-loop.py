...
grid_rest_path = scratch/"eNATL60_rest_grid.zarr" # "mesh_mask_eNATL60_3.6.nc" #
grid_mean_path = scratch/"eNATL60_mean_grid_z.zarr" #"eNATL60_mean_grid_z_one-chk-z.zarr"
...
restart = 2 # continue previously stopped job (y segments). 0, False or None to start from beginning
