...
from proj_pres_utils import proj_pres, get_pres_one_dg as get_pres
...
log_dir = Path(os.getenv("HOME"))/"working_on/processing/log"
...
logging.info("opened statif fields, reading from {}".format(grid_mode_path.name))
