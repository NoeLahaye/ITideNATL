""" utils.py
WARNING this file is deprecated and is kept only for backward-compatibility
it was used for time averaging of raw data, vertical mode computation and projection
split in itidenatl.tools on 2022/01/20 (NJAL)
"""
import os, shutil
